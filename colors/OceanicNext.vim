...
hi Directory guifg=#5294e2 ctermfg=68
hi ErrorMsg guifg=#ec5f67 ctermfg=203 guibg=#383c4a ctermbg=235
hi Exception guifg=#ec5f67 ctermfg=203
hi FoldColumn guibg=#404552 ctermbg=237
hi Folded guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237
hi IncSearch guifg=#404552 ctermfg=237 guibg=#f99157 ctermbg=209
...
hi Question guifg=#5294e2 ctermfg=68
...
hi Visual guibg=#404552 ctermbg=240
hi VisualNOS guifg=#ec5f67 ctermfg=203
hi WarningMsg guifg=#ec5f67 ctermfg=203
hi WildMenu guifg=#fffffD ctermfg=15 guibg=#5294e2 ctermbg=68
hi Title guifg=#5294e2 ctermfg=68 gui=NONE cterm=NONE
hi Conceal guifg=#5294e2 ctermfg=68 guibg=#383c4a ctermbg=235
hi Cursor guifg=#383c4a ctermfg=235 guibg=#c0c5ce ctermbg=251
hi NonText guifg=#65737e ctermfg=243
hi Normal guifg=#ffffff ctermfg=251 guibg=#383c4a ctermbg=235
hi LineNr guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237
hi CursorLineNR guifg=#eae5e5 ctermfg=15 guibg=#eae5e5 ctermbg=15
hi SignColumn guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237
hi StatusLine guifg=#a7adba ctermfg=145 guibg=#404552 ctermbg=240 gui=NONE cterm=NONE
hi StatusLineNC guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi VertSplit guifg=#404552 ctermfg=240 guibg=#404552 ctermbg=240 gui=NONE cterm=NONE
hi ColorColumn guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi CursorColumn guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi CursorLine guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi CursorLineNr guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237
hi PMenu guifg=#a7adba ctermfg=145 guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi PMenuSel guifg=#404552 ctermfg=237 guibg=#a7adba ctermbg=145
hi PmenuSbar guibg=#404552 ctermbg=240
hi PmenuThumb guibg=#d8dee9 ctermbg=253
hi TabLine guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi TabLineFill guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
hi TabLineSel guifg=#99c794 ctermfg=114 guibg=#404552 ctermbg=237 gui=NONE cterm=NONE
...
hi Function guifg=#5294e2 ctermfg=68
hi Identifier guifg=#ec5f67 ctermfg=203 gui=NONE cterm=NONE
hi Include guifg=#5294e2 ctermfg=68
...
hi Todo guifg=#fac863 ctermfg=221 guibg=#404552 ctermbg=237
hi Type guifg=#fac863 ctermfg=221 gui=NONE cterm=NONE
hi Typedef guifg=#fac863 ctermfg=221
hi SpellBad guibg=#383c4a ctermbg=235 gui=undercurl cterm=undercurl
hi SpellLocal guibg=#383c4a ctermbg=235 gui=undercurl cterm=undercurl
hi SpellCap guibg=#383c4a ctermbg=235 gui=undercurl cterm=undercurl
hi SpellRare guibg=#383c4a ctermbg=235 gui=undercurl cterm=undercurl
...
hi csAssignment guifg=#5294e2 ctermfg=68
...
hi DiffAdd guifg=#99c794 ctermfg=114 guibg=#404552 ctermbg=237
hi DiffChange guifg=#65737e ctermfg=243 guibg=#404552 ctermbg=237
hi DiffDelete guifg=#ec5f67 ctermfg=203 guibg=#404552 ctermbg=237
hi DiffText guifg=#5294e2 ctermfg=68 guibg=#404552 ctermbg=237
hi DiffAdded guifg=#eae5e5 ctermfg=15 guibg=#99c794 ctermbg=114
hi DiffFile guifg=#ec5f67 ctermfg=203 guibg=#383c4a ctermbg=235
hi DiffNewFile guifg=#99c794 ctermfg=114 guibg=#383c4a ctermbg=235
hi DiffLine guifg=#5294e2 ctermfg=68 guibg=#383c4a ctermbg=235
...
hi markdownHeadingDelimiter guifg=#5294e2 ctermfg=68
...
hi markdownError guifg=#c0c5ce ctermfg=251 guibg=#383c4a ctermbg=235
hi NeomakeErrorSign guifg=#ec5f67 ctermfg=203 guibg=#404552 ctermbg=237
hi NeomakeWarningSign guifg=#fac863 ctermfg=221 guibg=#404552 ctermbg=237
hi NeomakeInfoSign guifg=#eae5e5 ctermfg=15 guibg=#404552 ctermbg=237
...
hi NERDTreeDirSlash guifg=#5294e2 ctermfg=68
...
hi rubyAttribute guifg=#5294e2 ctermfg=68
...
hi sassMixinName guifg=#5294e2 ctermfg=68
hi vimfilerLeaf guifg=#c0c5ce ctermfg=251
hi vimfilerNormalFile guifg=#c0c5ce ctermfg=251 guibg=#383c4a ctermbg=235
hi vimfilerOpenedFile guifg=#5294e2 ctermfg=68
hi vimfilerClosedFile guifg=#5294e2 ctermfg=68
hi GitGutterAdd guifg=#99c794 ctermfg=114 guibg=#404552 ctermbg=237
hi GitGutterChange guifg=#5294e2 ctermfg=68 guibg=#404552 ctermbg=237
hi GitGutterDelete guifg=#ec5f67 ctermfg=203 guibg=#404552 ctermbg=237
hi GitGutterChangeDelete guifg=#c594c5 ctermfg=176 guibg=#404552 ctermbg=237
